...
import com.lzh.yuanstrom.widget.ExpandableItemIndicator;

import static com.h6ah4i.android.widget.advrecyclerview.expandable.ExpandableItemConstants.STATE_FLAG_HAS_EXPANDED_STATE_CHANGED;
...
public class ExpandableDraggableSwipeableExampleAdapter
    ...
    public void onBindGroupViewHolder(MyGroupViewHolder holder, int groupPosition, int viewType) {
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0) ||
            ...
            int bgResId;
            boolean isExpanded;
            boolean animateIndicator = ((expandState & STATE_FLAG_HAS_EXPANDED_STATE_CHANGED) != 0);
    ...
    public void onBindChildViewHolder(MyChildViewHolder holder, int groupPosition, int childPosition, int viewType) {
        // child item
        final SimpleDeviceBean item = mProvider.getChildItem(groupPosition, childPosition);
