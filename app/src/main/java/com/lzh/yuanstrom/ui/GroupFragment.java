...
import com.lzh.yuanstrom.adapter.ExpandableDraggableSwipeableExampleAdapter;
...
public class GroupFragment extends Fragment
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        myItemAdapter =
                new ExpandableDraggableSwipeableExampleAdapter(mRecyclerViewExpandableItemManager, ((GroupActivity)getActivity()).getDataProvider());
    ...
    public ExpandableDraggableSwipeableExampleAdapter getMyItemAdapter() {
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ((GroupActivity) getActivity()).onGroupItemClicked(groupPosition);
        } else {
            ((GroupActivity) getActivity()).onChildItemClicked(groupPosition, childPosition);
        }
    }
